...
const styles = StyleSheet.create({
  ...
  backText: { fontSize: 15, fontFamily: FWB.medium },
  titleWrap: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  title: { fontSize: 18, fontFamily: FWB.semibold, lineHeight: 24 },
  ...
  statSub: { fontSize: 12, fontFamily: FWB.normal, lineHeight: 12 },
  historyCard: {
    marginTop: 16,
    borderRadius: 16,
    padding: 20,
  ...
  historyValue: { color: '#fff', fontFamily: FWB.semibold, fontSize: 12 },
  historyValueSuffix: { fontSize: 10, opacity: 0.7, marginLeft: 2 },
  historyDate: { fontSize: 12, fontFamily: FWB.medium },
