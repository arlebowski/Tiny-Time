...
const DailyActivityChart = ({
  ...
  }, [days, feedings?.length, sleepSessions?.length]);
  ...
  const PLOT_H = effectiveViewMode === 'day' ? 480 : 280;
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            {
              className: 'flex',
              style: { minWidth: effectiveViewMode === 'day' ? '100%' : `${days * (effectiveViewMode === 'month' ? 56 : 80)}px` }
            },
            dayStarts.map((day0) => {
              const ws = windowStartMs(day0);
              const we = windowEndMs(day0);
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  daySleeps.map((ev, idx) => {
                    ...
                    // Sleep colors matching legend: purple for sleep, blue for naps
                    const bgColor = sleepType === 'night'
                      ? '#8B5CF6' // Purple for sleep
                      : '#60A5FA'; // Blue for naps
                  ...
                  dayFeeds.map((ev, idx) => { 
                    ...
                    // Feed color matching legend
                    const tickColor = '#F43F5E';
