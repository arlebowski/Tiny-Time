...
const DailyActivityChart = ({
  ...
  const feeds = (Array.isArray(feedings) ? feedings : [])
    .map((f) => ({ ...f, s: toMs(f.timestamp ?? f.time ?? f.at ?? f.startAt ?? f.start) }))
    .filter((f) => !!f.s);
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'flex-1 overflow-x-auto', ref: scrollRef, style: { scrollBehavior: 'smooth' } },
          React.createElement(
            'div',
              ...
              return React.createElement(
                ...
                React.createElement(
                  ...
                  daySleeps.map((ev, idx) => {
                    ...
                    // Active sleep on today: slightly more vibrant indigo
                    // Regular sleep: standard purple-indigo (rgba(99,102,241,0.28))
                    const bgColor = isToday && isActive
                  ...
                  // feed ticks (horizontal) - uses accent indigo (#4F46E5 = rgb 79,70,229)
                  dayFeeds.map((ev, idx) => {
                    const top = yPct(ev.s, day0);
