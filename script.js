  ...
  if (!babyWeight && !isEditingWeight) {
    return React.createElement('div', { 
      ...
      React.createElement('div', { className: "bg-white rounded-2xl shadow-xl p-8 max-w-md w-full" },
        ...
        React.createElement('h1', { className: "text-2xl font-bold text-gray-800 text-center mb-2" }, 'Welcome!'),
      ...
      React.createElement('div', { className: "bg-white rounded-2xl shadow-lg p-6 mb-4" },
        ...
        React.createElement('div', { className: "flex items-center justify-between mb-4" },
          React.createElement('div', { className: "flex items-center gap-3" },
            ...
            React.createElement('h1', { className: "text-2xl font-bold text-gray-800" }, 'Feeding Tracker')
          ),
          React.createElement('button', {
